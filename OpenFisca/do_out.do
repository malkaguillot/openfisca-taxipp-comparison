...
global dic_scenar "{'activite': 0, 'option': 'sali', 'scenario': 'concubin', 'activite_C': 0, 'part_rev': 0.75, 'rev_max': 50000, 'datesim': 2013, 'date': '10-02-14 19h25', 'nmen': 10, 'nb_enf': 3, 'age_enf': [17, 8, 12]}"
global public_C 0
global activite 0
global npac 3
global option sali
global annee_sim 2013
global public 0
global taille_ent_C 5
global part_rev 0.75
global f2dc 0
global f2tr 0
global couple 1
global tva_ent 0
global date 10-02-14 19h25
global nmen 10
global caseEKL 0
global ISF 0
global taille_ent 5
global nbj_nonsal_C 0
global nbh_sal 1820.04
...
global cadre 0
global caseT 0
global rev_max 50000
global age 38
global nbh_sal_C 1820.04
global tva_ent_C 0
global npac_C 0
global loyer_mensuel_menage 1000
global f3vg 0
global cadre_C 0
global age_enf 17  8  12
global f4ba 0
...
replace age = ${age_C} if (conj == 1 | con2 == 1)
replace age = ${age} if (decl == 1 & couple == 0) | (decl == 1 & marie == 1) | con1 == 1

replace age_conj = ${age} if (conj == 1 | con2 == 1)
replace age_conj = ${age} if (decl == 1 & couple == 0) | (decl == 1 & marie == 1) | con1 == 1
...
gen nenf = nenfnaiss + nenf02+ nenf35 + nenf610 + nenf1113 + nenf1415 + nenf1617
...
gen nbj = 0
replace nbj = ${nbj_nonsal_C} if con2 == 1 | conj == 1
replace nbj = ${nbj_nonsal} if (decl == 1 & couple == 0) | (decl == 1 & marie == 1) | con1 == 1
