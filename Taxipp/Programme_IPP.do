...
replace chom_irpp = rev_temp     if ${activite} == 1 & ((decl == 1 & couple == 0) | (decl == 1 & marie == 1) | con1 == 1) /* Chômeur */
replace pension_irpp = rev_temp if ${activite} == 3 & ((decl == 1 & couple == 0) | (decl == 1 & marie == 1) | con1 == 1) /* Retraité */
drop rev_temp
